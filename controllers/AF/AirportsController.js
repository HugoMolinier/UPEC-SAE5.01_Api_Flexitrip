...
exports.getAllAirports = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Erreur serveur lors de la récupération des aéroports",
      });
  }
};
...
exports.getAirportById = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({
        message: "Erreur serveur lors de la récupération de l'aéroport",
      });
  }
};
...
exports.createAirport = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur serveur lors de la création de l'aéroport" });
  }
};
...
exports.updateAirport = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur serveur lors de la mise à jour de l'aéroport" });
  }
};
...
exports.deleteAirport = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur serveur lors de la suppression de l'aéroport" });
  }
};
